 ...
 * @version Sep 19, 2026
 */
public class SessionTest extends student.TestCase {
    ...
    public void setUp() {
        ...
        session1 = new Session(running, 15, 60, Instant.parse(
    ...
    public void testSession() {
        ...
        assertEquals("Duration cannot be equal to or less than 0 minutes",
    ...
    public void testGetDate() {
        assertTrue(Instant.parse("2026-09-19T15:30:00Z").equals(session1
            .getDate()));
